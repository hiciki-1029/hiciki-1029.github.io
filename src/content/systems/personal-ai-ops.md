...
它和知识库、关键对话 Lab、在线测评是同一批产物：一次主动叫停之后，我用这套更轻的组合替换掉了原来的重交付项目。那次取舍怎么判断的，记在[《用判断力换确定性》](/writing/judgment-over-certainty/)里。
